...
# 프로그래머 정보
- 전하윤(팀장) : 전반적인 개발 담당, DB 설계, 공통 파트, 메인 페이지, 가맹점 페이지, 문자 인증 API 연동, 회원가입 문자 인증 기능, 카카오 Map API 연동, 가맹점 위치 지도상 마커 표시 및 길찾기 기능, Naver Clova OCR API 연동, 영수증 인증 및 팝업(Modal) 기능, 게시판 썸네일 기능 구현
