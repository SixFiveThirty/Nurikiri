...
<i class="far fa-edit"></i> 가맹점 수정페이지
</h1>
<div class="panel panel-default">
<div class="panel-body">
	<form:form modelAttribute="storeAdmin" role="form"
		...
		<a href="${cri.getLinkWithEno('get', store.sno)}"
...
<form id="getForm" action="managers/store/get" method="get">
<input type="hidden" id="sno" name="sno" value="${store.sno}" />
<input type="hidden" name="pageNum" value="${cri.pageNum}" />
<input type="hidden" name="amount" value="${cri.amount}" />
</form>
